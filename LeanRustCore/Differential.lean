...
def extractedDeclarationAssertions : List RustAssertion := [
  ...
  assertion "state_do_tick_u32(41)" "(41u32, 42u32)",
  assertion "state_seq_right_u32(5)" "(6u32, 5u32)",
  assertion "state_seq_left_u32(5)" "(5u32, 6u32)",
  assertion "except_state_do_u32(Err(7), 2)" "(Err(7u32), 2u32)",
  assertion "except_state_do_u32(Ok(40), 2)" "(Ok(42u32), 3u32)",
  assertion "except_state_seq_right_u32(Err(7), 2)" "(Err(7u32), 2u32)",
