...
def extractedDeclarationAssertions : List RustAssertion := [
  ...
  assertion "step_amount_or(Step::Stay, 9)" (rustU32 9),
  assertion "step_amount_or(Step::Jump(12), 9)" (rustU32 12),
  assertion "inc_twice_u32(40)" (rustU32 42),
  assertion "inc_twice_u32(u32::MAX)" (rustU32 1),
