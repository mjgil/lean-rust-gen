...
This pass extends the direct Lean emits Rust implementation through steps 1-8, plus the next four implementation items: payload enum pattern matching, first-order function-call lowering, a SurfaceExpr evaluator, and expanded surface differential tests:
