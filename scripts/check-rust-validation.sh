...
grep -q 'except_state_do_u32(Ok(40), 2)' "$differential_tests"
grep -q 'except_state_seq_right_u32(Ok(40), 2)' "$differential_tests"
grep -q 'except_state_seq_left_u32(Ok(40), 2)' "$differential_tests"
grep -q 'io_boundary_transcript(String::from("hello"), String::from("HOME"), 42)' "$differential_tests"
grep -q 'eio_boundary_transcript(String::from("hello"), String::from("HOME"), 42)' "$differential_tests"
...
grep -q 'pub fn except_state_do_u32' "$generated"
grep -q 'pub fn except_state_seq_right_u32' "$generated"
grep -q 'pub fn except_state_seq_left_u32' "$generated"
grep -q 'pub fn io_boundary_transcript' "$generated"
grep -q 'pub fn eio_boundary_transcript' "$generated"
