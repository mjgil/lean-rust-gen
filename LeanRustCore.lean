...
* first-order helper extraction, conservative proof erasure, unary Rust `fn` pointer arguments, explicit closure-converted environments, finite defunctionalized function cases, dependent-shape erasure, recursive Box-owned data, validation-v2 coverage metadata, deterministic property seeds, stable diagnostics, workspace crate design, and release-matrix metadata support the phase-2 large-subset slice,
