...
pub struct ValidationFeatureSummary {
    ...
    pub next20_completion: Vec<String>,
    pub numeric_modes: Vec<String>,
    pub numeric_semantics_modes: Vec<String>,
    pub pattern_matching_functions: u64,
    pub pattern_matrix_heads: Vec<String>,
    pub pure_effects: Vec<String>,
    pub recursive_layout_modes: Vec<String>,
    pub remaining_completion: Vec<String>,
    pub rust_generic_policy: String,
...
pub struct ProofPolicy {
    ...
    pub recursive_layout_modes: String,
    ...
    pub rust_generic_policy_finalized: String,
